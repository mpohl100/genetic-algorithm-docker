...
conan install .. --build=missing --output-folder=conan_output -pr="$(pwd)/../conan_profiles/gcc11_cpp20.prof" -c tools.system.package_manager:mode=install -c tools.system.package_manager:sudo=True 
